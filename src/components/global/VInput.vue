<template>
  <div class="input-wrapper">
    ...
    <input ref="input" :class="{'!border-b-red-600':errorFlag}" :type="passwordIconToggleFlag ? 'text' : type" :placeholder="placeholder" class="v-input" :id="label" @input="inputHandler($event)" :value="modelValue" type="text">
