...
@layer components {
  .footer{
    @apply p-1.5 !pr-2 sm:ml-[260px] sm:w-[calc(100vw-260px)] transition-all shadow-[0_0_30px_rgba(0,0,0,0.1)] flex sm:flex-row flex-col justify-between items-center bg-primary-light-1 dark:bg-primary-dark-1
  }
  .footer.n-collapse{
